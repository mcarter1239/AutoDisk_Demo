...
# def samePadding(pattern,kernel):
#     """
...
#     """
#     f_size = len(kernel)
#     constant = np.empty((pattern.shape[0]+2*f_size,pattern.shape[1]+2*f_size))
#     bcgd = np.mean(pattern[:f_size,f_size:])
#     constant[0:f_size,:] = constant[-f_size:pattern.shape[0]+2*f_size,:] = constant[:,0:f_size] = constant[:,f_size:pattern.shape[1]+2*f_size] = bcgd
#     constant[f_size:pattern.shape[0]+f_size,f_size:pattern.shape[1]+f_size] = pattern
